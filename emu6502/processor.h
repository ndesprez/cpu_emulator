...
protected:
	...
	const Instruction	LegalInstructionSet[151] = {
		...
		{0x0A, "ASL", sImplied, tAccumulator, &Processor::ShiftLeft},
		...
		{0x4A, "LSR", sImplied, tAccumulator, &Processor::ShiftRight},
		...
		{0x2A, "ROL", sImplied, tAccumulator, &Processor::RotateLeft},
		...
		{0x6A, "ROR", sImplied, tAccumulator, &Processor::RotateRight},
